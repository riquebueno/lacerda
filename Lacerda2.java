	...
	public static void main(String[] args) {
		...
		do{
			...
			if(destino==-1){
				...
				System.out.println("Não entendi :( desculpa mas me confundo algumas vezes ... você pode tentar de novo?");
				...
				*/
				...
				if(destino==0){
					System.out.println("Oi! Digite a pergunta em etapas e olhe as sugestões ;)");
				}
				else{
					System.out.println("Sim, estou entendendo ;) pode continuar ...");
				}
			...
			System.out.print("Escolha uma sugestão ou sair (sua pergunta esta " + estadoPergunta + " formada): ");
